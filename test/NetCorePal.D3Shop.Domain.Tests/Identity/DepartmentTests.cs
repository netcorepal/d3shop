...
namespace NetCorePal.D3Shop.Domain.Tests.Identity
{
    ...
    public class DepartmentTests
    {
            ...
            var initialUsers = new List<DepartmentUser>
        {
            ...
            _department = new Department("InitialName", "InitialDescription", new DeptId(1), initialUsers,0);
        }
        ...
        public void UpdateDepartInfo_ShouldUpdateNameAndDescription()
        {
            ...
            _department.UpdateDepartInfo(newName,"001", newDescription,0, _department.Users);
            ...
            var newUsers = new List<DepartmentUser>
        {
            ...
            _department.UpdateDepartInfo(_department.Name, "001", _department.Description, 0, newUsers);
